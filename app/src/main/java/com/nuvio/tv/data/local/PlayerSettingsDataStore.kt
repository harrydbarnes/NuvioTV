...
data class SubtitleStyleSettings(
    ...
    val hideUnpreferredLanguages: Boolean = false,
...
class PlayerSettingsDataStore @Inject constructor(
    ...
    private val subtitleHideUnpreferredLanguagesKey = booleanPreferencesKey("subtitle_hide_unpreferred_languages")
        ...
        factory.get(pid, FEATURE).data.map { prefs ->
            PlayerSettings(
                ...
                subtitleStyle = SubtitleStyleSettings(
                    ...
                    hideUnpreferredLanguages = prefs[subtitleHideUnpreferredLanguagesKey] ?: false,
    ...
    suspend fun setSubtitleHideUnpreferredLanguages(hide: Boolean) {
        store().edit { prefs ->
            prefs[subtitleHideUnpreferredLanguagesKey] = hide
        }
    }
