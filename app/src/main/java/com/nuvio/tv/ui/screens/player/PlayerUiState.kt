...
sealed class PlayerEvent {
    ...
    data class OnSelectSubtitleTrack(val index: Int, val showOverlay: Boolean = true) : PlayerEvent()
    data object OnDisableSubtitles : PlayerEvent()
    data object OnToggleSubtitles : PlayerEvent()
    data class OnSelectAddonSubtitle(val subtitle: Subtitle, val showOverlay: Boolean = true) : PlayerEvent()
